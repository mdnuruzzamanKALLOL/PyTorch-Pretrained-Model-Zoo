...
from shufflenet_v2_x1_5 import shufflenet_v2_x1_5
...
model     = shufflenet_v2_x1_5(num_classes=NUM_CLASSES).to(DEVICE)
...
torch.save(model.state_dict(), 'shufflenet_v2_x1_5_best.pth')
print('Model saved: shufflenet_v2_x1_5_best.pth')
