...
optimizer = optim.AdamW([
    {'params': [p for n, p in model.named_parameters() if n != 'fc.weight' and n != 'fc.bias'],
     'lr': 1e-5},
...
print('Fine-Tuning — backbone lr=1e-5, fc lr=1e-3')
...
torch.save(model.state_dict(), 'shufflenet_v2_x1_0_ft.pth')
print('Saved: shufflenet_v2_x1_0_ft.pth')
