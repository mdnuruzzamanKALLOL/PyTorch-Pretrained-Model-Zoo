...
WEIGHTS     = sys.argv[3] if len(sys.argv) > 3 else 'efficientnet_b7_best.pth'
...
model = efficientnet_b7(num_classes=NUM_CLASSES).to(DEVICE)
...
print(f'\nEfficientNet-B7 — Inference Results')
print('=' * 45)
BAR_LEN = 30
