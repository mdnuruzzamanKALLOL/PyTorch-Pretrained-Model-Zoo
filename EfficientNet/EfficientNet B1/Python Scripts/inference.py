...
WEIGHTS     = sys.argv[3] if len(sys.argv) > 3 else 'efficientnet_b1_best.pth'
...
model = efficientnet_b1(num_classes=NUM_CLASSES).to(DEVICE)
...
print(f'\nEfficientNet-B1 — Inference Results')
print('=' * 45)
BAR_LEN = 30
