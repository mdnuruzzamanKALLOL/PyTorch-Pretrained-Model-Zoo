...
from regnet_y_8gf import regnet_y_8gf
...
model     = regnet_y_8gf(num_classes=NUM_CLASSES).to(DEVICE)
...
torch.save(model.state_dict(), 'regnet_y_8gf_best.pth')
print('Model saved: regnet_y_8gf_best.pth')
