...
from regnet_x_800mf import regnet_x_800mf
...
model     = regnet_x_800mf(num_classes=NUM_CLASSES).to(DEVICE)
...
torch.save(model.state_dict(), 'regnet_x_800mf_best.pth')
print('Model saved: regnet_x_800mf_best.pth')
