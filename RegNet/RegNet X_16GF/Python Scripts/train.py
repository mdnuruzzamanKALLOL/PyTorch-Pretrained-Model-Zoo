...
from regnet_x_16gf import regnet_x_16gf
...
model     = regnet_x_16gf(num_classes=NUM_CLASSES).to(DEVICE)
...
torch.save(model.state_dict(), 'regnet_x_16gf_best.pth')
print('Model saved: regnet_x_16gf_best.pth')
