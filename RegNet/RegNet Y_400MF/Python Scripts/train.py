...
from regnet_y_400mf import regnet_y_400mf
...
model     = regnet_y_400mf(num_classes=NUM_CLASSES).to(DEVICE)
...
torch.save(model.state_dict(), 'regnet_y_400mf_best.pth')
print('Model saved: regnet_y_400mf_best.pth')
