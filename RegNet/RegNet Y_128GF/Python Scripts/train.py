...
from regnet_y_128gf import regnet_y_128gf
...
model     = regnet_y_128gf(num_classes=NUM_CLASSES).to(DEVICE)
...
torch.save(model.state_dict(), 'regnet_y_128gf_best.pth')
print('Model saved: regnet_y_128gf_best.pth')
