...
from regnet_x_8gf import regnet_x_8gf
...
model     = regnet_x_8gf(num_classes=NUM_CLASSES).to(DEVICE)
...
torch.save(model.state_dict(), 'regnet_x_8gf_best.pth')
print('Model saved: regnet_x_8gf_best.pth')
