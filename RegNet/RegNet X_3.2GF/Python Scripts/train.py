...
from regnet_x_3_2gf import regnet_x_3_2gf
...
model     = regnet_x_3_2gf(num_classes=NUM_CLASSES).to(DEVICE)
...
torch.save(model.state_dict(), 'regnet_x_3_2gf_best.pth')
print('Model saved: regnet_x_3_2gf_best.pth')
