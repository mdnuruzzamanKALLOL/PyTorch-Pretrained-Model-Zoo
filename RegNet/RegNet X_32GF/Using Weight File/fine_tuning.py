...
model    = models.regnet_x_32gf(weights=models.RegNet_X_32GF_Weights.IMAGENET1K_V1)
...
torch.save(model.state_dict(), 'regnet_x_32gf_ft.pth')
print('Saved: regnet_x_32gf_ft.pth')
