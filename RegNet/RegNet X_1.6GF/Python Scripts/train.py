...
from regnet_x_1_6gf import regnet_x_1_6gf
...
model     = regnet_x_1_6gf(num_classes=NUM_CLASSES).to(DEVICE)
...
torch.save(model.state_dict(), 'regnet_x_1_6gf_best.pth')
print('Model saved: regnet_x_1_6gf_best.pth')
