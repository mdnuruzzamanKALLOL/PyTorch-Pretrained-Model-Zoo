...
from regnet_x_400mf import regnet_x_400mf
...
model     = regnet_x_400mf(num_classes=NUM_CLASSES).to(DEVICE)
...
torch.save(model.state_dict(), 'regnet_x_400mf_best.pth')
print('Model saved: regnet_x_400mf_best.pth')
