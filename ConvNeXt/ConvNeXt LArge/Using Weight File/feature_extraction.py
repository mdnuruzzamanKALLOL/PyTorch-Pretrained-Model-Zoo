...
NUM_CLASSES = 10;  BATCH_SIZE = 8;  EPOCHS = 5;  LR = 1e-3
DATA_DIR    = "./data"
...
if __name__ == "__main__":
    print(f"Device : {DEVICE}  |  Mode : Feature Extraction (ConvNeXt-Large)\n")
    model = build_model()
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if vl_acc > best_acc:
            best_acc = vl_acc; torch.save(model.state_dict(), "convnext_large_feature_extract.pth")
