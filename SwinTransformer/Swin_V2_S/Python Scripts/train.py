...
from swin_v2_s import swin_v2_s
...
model     = swin_v2_s(num_classes=NUM_CLASSES).to(DEVICE)
...
torch.save(model.state_dict(), 'swin_v2_s_best.pth')
print('Model saved: swin_v2_s_best.pth')
