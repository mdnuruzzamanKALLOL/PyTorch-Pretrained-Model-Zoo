...
from squeezenet1_1 import squeezenet1_1
...
model     = squeezenet1_1(num_classes=NUM_CLASSES).to(DEVICE)
...
torch.save(model.state_dict(), 'squeezenet1_1_best.pth')
print('Model saved: squeezenet1_1_best.pth')
