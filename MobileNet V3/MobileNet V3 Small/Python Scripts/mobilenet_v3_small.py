...
class MobileNetV3(nn.Module):
    def __init__(self, bneck_config, last_conv_ch=576, last_channel=1024,
...
def mobilenet_v3_small(num_classes=1000):
    return MobileNetV3(SMALL_CONFIG, last_conv_ch=576,
                       last_channel=1024, num_classes=num_classes)
