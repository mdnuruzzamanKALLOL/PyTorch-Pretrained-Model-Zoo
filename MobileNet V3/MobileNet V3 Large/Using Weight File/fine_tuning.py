...
optimizer = optim.AdamW([
    {'params': [p for n, p in model.named_parameters() if 'classifier.3' not in n],
      'lr': LR_BACKBONE},
    {'params': model.classifier[3].parameters(), 'lr': LR_HEAD},
])
...
for epoch in range(1, EPOCHS + 1):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), 'mobilenet_v3_large_fine_tuned.pth')

print(f'Best Val Acc: {best_val_acc:.2f}%')
print('Saved: mobilenet_v3_large_fine_tuned.pth')
