...
def load_model(weights_path, num_classes=10):
    model = densenet169(num_classes=num_classes).to(DEVICE)
...
def predict(model, image_path, class_names=None, top_k=5):
    ...
    print(f"\nDenseNet-169 Inference — {image_path}")
    print("=" * 50)
...
if __name__ == "__main__":
    ...
    weights_path = sys.argv[3] if len(sys.argv) > 3 else "densenet169_best.pth"
