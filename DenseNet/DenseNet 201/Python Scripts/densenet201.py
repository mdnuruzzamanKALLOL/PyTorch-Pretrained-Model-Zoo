...
class DenseNet(nn.Module):
    def __init__(self,growth_rate=32,block_config=(6,12,48,32),num_init_features=64,bn_size=4,drop_rate=0.0,num_classes=1000):
        super().__init__()
...
def densenet201(num_classes=1000): return DenseNet(growth_rate=32,block_config=(6,12,48,32),num_init_features=64,num_classes=num_classes)

def count_parameters(model,name="DenseNet-201"):
